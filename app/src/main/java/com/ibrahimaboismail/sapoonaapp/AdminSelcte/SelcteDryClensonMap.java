package com.ibrahimaboismail.sapoonaapp.AdminSelcte;
...
import com.ibrahimaboismail.sapoonaapp.AdminListpestActivity;
import com.ibrahimaboismail.sapoonaapp.Models.PlaceInfo;
import com.ibrahimaboismail.sapoonaapp.PlaceAutocompleteAdapter;
...
public class SelcteDryClensonMap extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selcted_dryclens_on_maps);
    ...
    private void init(){
        ...
        mGps.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mFusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(SelcteDryClensonMap.this);
                try {
                    if (mLocationPremissonsGreanted){
                        ...
                        location.addOnCompleteListener(new OnCompleteListener() {
                            ...
                            public void onComplete(@NonNull Task task) {
                                if (task.isSuccessful()){
                                    ...
                                    Toast.makeText(SelcteDryClensonMap.this, "unblea to get current location", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
    ...
    private void geoLocate(){
        ...
        Geocoder geocoder = new Geocoder(SelcteDryClensonMap.this);
    ...
    private void moveCamera(LatLng latLng, float zoom, String title){
        ...
        if (!title.equals("My Location")){
            ...
            CircleOptions circleOptions = new CircleOptions()
                    ...
                    .fillColor(getColor(R.color.mapps));
    ...
    private void initMap() {
        ...
        mapFragment.getMapAsync(SelcteDryClensonMap.this);
    }
...
//                }
               ...
               movetoAplayorder();
                //mPlace.getAddress().toString(),lat,lon
            }
        });
    }

    private void movetoAplayorder(){
       // String address,double lat,double lon
           Intent intent = new Intent(SelcteDryClensonMap.this,AdminListpestActivity.class);
